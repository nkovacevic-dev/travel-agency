...
<head>
    ...
    <style>
        ...
        .field-label { font-size: 12px; font-weight: 600; text-transform: uppercase; color: #718096; margin-bottom: 4px; }
        .field-value { font-size: 15px; color: #2d3748; line-height: 1.6; }
        .poruka-box { background-color: #f7fafc; border-left: 4px solid #1a5f7a; padding: 16px; border-radius: 0 4px 4px 0; font-size: 15px; line-height: 1.7; color: #2d3748; white-space: pre-wrap; }
